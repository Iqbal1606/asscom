      ...
      <class class="row no-gutters mt-5 fixed-top">
          <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="DaftarPengumpulan_Tugas.php"><i class="fas fa-file-upload me-2"></i>Daftar Pengumpulan Tugas</a><hr class="bg-secondary">
                </li>
              </ul>
          </div>
          <class class="col-md-10 p-2 pt-4">
              <h3><i class="fas fa-file-upload me-2"></i>Daftar Pengumpulan Tugas</h3><hr class="bg-dark">
