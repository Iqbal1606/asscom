      ...
      <class class="row no-gutters mt-5 fixed-top">
          <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5">
                <li class="nav-item">
                  <a class="nav-link text-white" href="mahasiswa.php"><i class="fas fa-users me-2"></i>assigment</a><hr class="bg-secondary">
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="assigment.php"><i class="fas fa-list-alt me-3"></i></i>Tempat Uplod</a><hr class="bg-secondary">
                </li>
              </ul>
          </div>
          <class class="col-md-10 p-2 pt-4" id="profil">
              <h3><i class="fas fa-user me-2"></i>Tempat Uplod</h3><hr class="bg-dark">
              <class class="col-md-10 p-2 pt-4 ">
              <h5>Tempat Uplod File:</h5>
            <div class="mb-3">
